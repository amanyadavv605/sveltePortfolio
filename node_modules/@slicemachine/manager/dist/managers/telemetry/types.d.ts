...
export declare const SegmentEventType: {
    ...
    readonly sliceGenerationFeedback: "slice-generation-feedback";
};
...
export declare const HumanSegmentEventType: {
    ...
    readonly "slice-generation-feedback": "Slice Generation Feedback";
};
...
type SliceGenerationFeedback = SegmentEvent<typeof SegmentEventType.sliceGenerationFeedback, {
    type: "model";
    sliceId: string;
    variationId: string;
    feedback: "up" | "down";
