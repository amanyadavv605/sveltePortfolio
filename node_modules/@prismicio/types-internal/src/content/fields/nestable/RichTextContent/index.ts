...
export const RichTextLegacyContent = t.array(BlockLegacy)
type RichTextLegacyContent = t.TypeOf<typeof RichTextLegacyContent>
...
export const RichTextLegacy = (ctx: LegacyContentCtx) =>
	new t.Type<RichTextContent, WithTypes<RichTextLegacyContent>, unknown>(
		"RichTextLegacy",
		isRichTextContent,
		(u) => {
			return pipe(
				RichTextLegacyContent.decode(u),
				either.map((r) => ({ value: r, __TYPE__: RichTextContentType })),
			)
		},

		(r: RichTextContent): WithTypes<RichTextLegacyContent> => {
			return {
