...
const cli = index(`
	...
	`, {
  importMeta: { url: typeof document === "undefined" ? require("url").pathToFileURL(__filename).href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("cli.cjs", document.baseURI).href },
  flags: {
    config: {
      type: "string",
      shortFlag: "c",
